...
const NAV_GROUPS: Array<{ group: string; screens: { href: string; label: string }[] }> = [
  {
    ...
    screens: [
      ...
      { href: "/profesional/pendiente", label: "Dersux Pro · Pendiente" },
      { href: "/profesional/bloqueado", label: "Dersux Pro · Bloqueado" },
    ],
  },
  {
    group: "Cliente",
    screens: [
      ...
      { href: "/cliente/trabajos/j1/aceptar?proId=p1", label: "Aceptar profesional Dersux" },
      ...
      { href: "/cliente/trabajos/j4/valorar", label: "Valorar profesional Dersux" },
  ...
  },
  {
    ...
    screens: [
      ...
      { href: "/profesional/mi-perfil", label: "Perfil Dersux Pro" },
    ],
  },
  {
